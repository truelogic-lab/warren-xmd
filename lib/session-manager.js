...
// ============================================
// WHATSAPP VERSION
// Hardcoded — matches @angstvorfrauen/baileys build.
// Update this if WhatsApp forces a protocol upgrade.
// ============================================
const WHATSAPP_VERSION = [2, 3000, 1031276083];
...
export async function createSession(phoneNumber, plugins = null) {
  ...
  sock.ev.on('connection.update', async ({ connection, lastDisconnect }) => {
    if (connection === 'close') {
      ...
      // Exponential backoff — 405 waits 30s, others wait 5s
      const backoff = code === 405 ? 30000 : 5000;
